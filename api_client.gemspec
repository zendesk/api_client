...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      if RUBY_PLATFORM == "java" then s.add_runtime_dependency(%q<json_pure>) else s.add_runtime_dependency(%q<yajl-ruby>) end
      s.add_runtime_dependency(%q<faraday>, [">= 0.8.1"])
      s.add_runtime_dependency(%q<hashie>, [">= 1.2.0"])
      s.add_runtime_dependency(%q<multi_json>)
    else
      if RUBY_PLATFORM == "java" then s.add_dependency(%q<json_pure>) else s.add_dependency(%q<yajl-ruby>) end
